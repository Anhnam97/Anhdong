...
custom_version() {
    ...
    download_link="https://github.com/Anhnam97/Anhdong/raw/main/3x-ui-2.1.3/install.sh"
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://github.com/Anhnam97/Anhdong/raw/main/3x-ui-2.1.3/install.sh
    if [[ $? != 0 ]]; then
        echo ""
